...
def choose_filenames(pred_dir):
    ...
    """This function checks, for which models the showcase was already performed."""
...
def main():
    ...
    """This script takes the predictions generated by 'model_tester.py', and creates a showcase using matplotlib."""
