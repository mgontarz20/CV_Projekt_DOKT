...
def get_model_paths(cnn_paths):
    """The script checks folders for .h5 model files"""
    good_dirs = []
...
def load_imgs(img_dirs,size):
    ...
    """Function that loads images to array"""
...
def main():
    """This script is used to generate predictions on all models trained during preparation of this project."""
